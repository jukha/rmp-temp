...
function Home() {
  return (
    <main>
      <section className="flex h-[500px] flex-col items-center px-4 justify-center bg-[linear-gradient(to_right_bottom,rgba(49,84,44,0.8),rgba(16,71,52,0.8)),url('/assets/man-reading-book.ec0041cf.jpeg')] bg-cover bg-center">
        <h2 className="mb-10 text-3xl lg:text-4xl text-white">
      ...
      <section className="container mx-auto px-4 py-40 text-center">
        <h2 className="mb-4 text-3xl lg:text-4xl font-extrabold text-primary">
          Join the RMP Family
        </h2>
        <h4 className="text-xl lg:text-2xl">Love RMP? Let's make it official.</h4>
        <div className="my-20 grid lg:grid-cols-3 gap-10 justify-center">
